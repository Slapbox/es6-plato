...
function process(source, options, reportInfo) {
	...
	/*
	date: date,
	sloc: r.aggregateAverage.sloc.physical,
	lloc: r.aggregateAverage.sloc.logical,
	functions: r.functions.length,
	deliveredBugs: r.aggregateAverage.halstead.bugs,
	maintainability: r.maintainability,
	difficulty: r.aggregateAverage.halstead.difficulty
	*/



	report.aggregateAverage = report.aggregateAverage || {};
	report.aggregateAverage = _.clone(report.methodAggregate);
